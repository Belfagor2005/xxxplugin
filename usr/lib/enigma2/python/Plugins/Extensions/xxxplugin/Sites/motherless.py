...
Panel_list = [
	('motherless Top Rated'),
	('motherless Viewed'),
	('motherless Longest'),
	('motherless Recent'),
	('motherless Categories'),  # 5
	('SEARCH'),
]
...
class main(Screen):
	...
	def filterChannels(self, result):
		if result:
			...
			try:
				search = True
				self.session.open(motherlessporn2, name, url)
			except:
				return
		else:
			self.resetSearch()
	...
	def keyNumberGlobalCB(self, idx):
		...
		if sel == ("motherless Top Rated"):
			namex = "toprated"
			lnk = 'http://motherless.com/top-rated/'
			self.session.open(motherlessporn2, namex, lnk)
		elif sel == ("motherless Viewed"):
			namex = "viewed"
			lnk = 'http://motherless.com/most-viewed/'
			self.session.open(motherlessporn2, namex, lnk)
		elif sel == ("motherless Longest"):
			namex = "longest"
			lnk = 'http://motherless.com/longest/'
			self.session.open(motherlessporn2, namex, lnk)
		elif sel == ("motherless Recent"):
			namex = "recent"
			lnk = 'http://motherless.com/most-discussed/'
			self.session.open(motherlessporn2, namex, lnk)
		elif sel == ("motherless Categories"):
			namex = "categories"
			lnk = 'http://motherless.com/channels/'
			self.session.open(categories, namex, lnk)

		if sel == 'SEARCH':
			namex = sel.upper()
			lnk = 'https://www.motherless.com/search/'
...
class motherlessporn2(Screen):
	...
	def ok(self):
		...
		print('pages url: ', url)
		self.session.open(motherlessporn3, name, url)
