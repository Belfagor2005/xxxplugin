...
currversion = '1.0'
title_plug = 'Manporn '
desc_plugin = ('..:: Manporn by Lululla %s ::.. ' % currversion)
...
print(current)
print(parent)
pluglogo = os.path.join(PLUGIN_PATH, 'pic/manporn.png')
stripurl = ''
_session = None
Path_Movies = '/tmp/'
global search
...
Panel_list = [
    ("Manporn-latest"),
    ("Manporn-top-rated"),
    ("Manporn-most-popular"),
    ("Manporn-most-commented"),
    ("Manporn-most-favourited"),
    ("Manporn-private"),
    ("SEARCH"),
    ]
...
class main(Screen):
    ...
    def filterChannels(self, result):
        if result:
            ...
            try:
                search = True
                self.session.open(manporn1, name, url)
            except:
                return
        else:
            self.resetSearch()
    ...
    def keyNumberGlobalCB(self, idx):
        ...
        elif sel == ("Manporn-top-rated"):
            lnk = ("https://manporn.xxx/top-rated/")
        elif sel == ("Manporn-most-popular"):
            lnk = ("https://manporn.xxx/most-popular/")
        elif sel == ("Manporn-most-commented"):
            lnk = ("https://manporn.xxx/commented/")
        elif sel == ("Manporn-most-favourited"):
            lnk = ("https://manporn.xxx/favourited/")
        elif sel == ("Manporn-private"):
            lnk = ("https://manporn.xxx/private/")
        elif sel == ("SEARCH"):
            lnk = ("https://manporn.xxx/search/?q=")
        namex = sel.upper()
        if sel == 'SEARCH':
...
class manporn1(Screen):
    ...
    def play_that_shit(self, url, name):
        self.session.open(manporn2, name, url)

    def exit(self):
        self.close()


class manporn2(Screen):
    def __init__(self, session, name, url):
        self.session = session
        Screen.__init__(self, session)
        skin = os.path.join(skin_path, 'defaultListScreen.xml')
