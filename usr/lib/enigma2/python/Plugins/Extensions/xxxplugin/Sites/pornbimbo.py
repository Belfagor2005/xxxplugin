...
currversion = '1.0'
title_plug = 'Pornbimbo '
desc_plugin = ('..:: Pornbimbo by Lululla %s ::.. ' % currversion)
...
print(current)
print(parent)
pluglogo = os.path.join(PLUGIN_PATH, 'pic/pornobimbo.png')
stripurl = 'aHR0cDovL3Bvcm5iaW1iby5jb20vY2F0ZWdvcmllcy8='
_session = None
Path_Movies = '/tmp/'
# "http://pornbimbo.com/categories/"
